...
public class JobKoreaController {
    ...
    public String jobkoreaedit(@PathVariable("id") Long id, Model model,
    ...
    public String jobKoreaEditSubmit(@ModelAttribute JobKorea jobKorea,
                                     @RequestParam(name = "jobKoreatypecd", required = false, defaultValue = "") String jobKoreatypecd,
    ...
    public String jobKoreaDeleteSubmit(@RequestParam(name = "id") Long id) {
        // 삭제 처리 로직
