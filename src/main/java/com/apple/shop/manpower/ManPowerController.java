...
public class ManPowerController {
    ...
    public String manpowerwrite(
            ...
            @RequestParam(name = "jobkoreaId", required = false) String jobkoreaId,
...
//        System.out.println("jobkoreaId :" + jobkoreaId);
    ...
    public String manpoweradd(
    		...
    		@RequestParam(name = "workArea", required = false) String workArea,
    		@RequestParam(name = "careerYears", required = false) String careerYears,
    		@RequestParam(name = "educationLevel", required = false) String educationLevel,
    		@RequestParam(name = "remark", required = false) String remark,
    		@RequestParam(name = "proposal", required = false) String proposal,
    		@RequestParam(name = "jobkoreaId", required = false) String jobkoreaId,
    		@RequestParam(name = "certifications", required = false) String certifications,
    		@RequestParam(name = "skills", required = false) String skills,
    		@RequestParam(name = "additionalNote", required = false) String additionalNote,
    ...
    public String manpoweredit(@PathVariable("id") Long id, Model model,
    ...
    public String manpoweredit(
            @ModelAttribute(name = "manPower") ManPower manPower,
            @RequestParam(name = "jobPosition", required = false, defaultValue = "") String jobPosition,
            @RequestParam(name = "searchDate") LocalDate searchDate
    ) {
        manPower.setJobPosition(jobPosition);
    ...
    public String searchManpower(
    		@RequestParam(name = "searchDisplayName", required = false) String searchDisplayName,
    		@RequestParam(name = "searchArea", required = false) String searchArea,
    		@RequestParam(name = "searchName", required = false) String searchName,
    		@RequestParam(name = "searchSkills", required = false) String searchSkills,
    		@RequestParam(name = "searchremark", required = false) String searchremark,
    		@RequestParam(name = "searchcareerYears", required = false) String searchcareerYears,
            Model model) {
